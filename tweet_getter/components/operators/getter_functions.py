...
def get_tweets_by_dancer_id(tw_api: tweepy.API, user_id: str, n_max_items: int = inf):
    return tweepy.Cursor(tw_api.user_timeline, user_id = user_id, exclude_replies = True).items(n_max_items)    
